...
const OTPVerificationEmail = ({ validationCode }: PlaidVerifyIdentityEmailProps) => (
  <Html>
    <Head />
    <Body style={main}>
      <Container style={container}>
        <Img src={baseUrl} width="70" height="70" alt="Plaid" style={logo} />
        <Text style={tertiary}>Verify Your Identity</Text>
        <Heading style={secondary}>Enter the following code to finish registering account.</Heading>
        ...
        <Text style={paragraph}>
          Contact{' '}
          <Link href="mailto:ntuanloc205@gmail.com" style={link}>
            ntuanloc205@gmail.com
          </Link>{' '}
