...
const LABEL_MODULE = ['AUTH', 'MANAGE-PRODUCT', 'PROFILE', 'MEDIA', 'CART', 'ORDERS', 'REVIEWS', "PLAYLISTS"]
const LISTENER_MODULE = ['AUTH', 'PROFILE', 'MEDIA', 'CART', 'ORDERS', 'REVIEWS', "PLAYLISTS"]
