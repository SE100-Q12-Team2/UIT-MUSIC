...
import { CreateRoleBodySchema, CreateRoleResSchema, GetRoleDetailResSchema, GetRoleParamSchema, GetRoleQuerySchema, GetRolesResSchema, UpdateRoleBodySchema, UpdateRoleResSchema } from "src/routes/role/role.model";
